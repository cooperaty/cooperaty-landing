  ...
  theme: {
    ...
    extend: {
      backgroundImage: (_) => ({
        ...
        'cooperaty': "url('../public/img/background.png')",
      }),
      height: {
        450: '450px',
        500: '500px',
      ...
      colors: {
        primary: { light: '#01C4FF', dark: '#0161FF' },
        'secondary-1': { light: '#01C4FF', dark: '#0161FF' },
        'secondary-2': { light: '#01C4FF', dark: '#0161FF' },
        ...
        'cooperaty-theme': {
          ...
          'bkg-1': 'rgba(0,0,0,1)',
          'bkg-2': 'rgba(0,0,0,0.5)',
          'bkg-3': 'rgba(0,0,0,0.5)',
          'bkg-4': 'rgba(0,0,0,0.2)',
          'fgd-1': '#F0EDFF',
          'fgd-2': '#E5E3EC',
          'fgd-3': '#C1BED3',
          'fgd-4': '#706C81',
          'fgd-5': 'linear-gradient(254deg, var(--primary-light) 0%, var(--primary) 100%)',
        },
        'th-bkg-1': 'var(--bkg-1)',
        'th-bkg-2': 'var(--bkg-2)',
        'th-bkg-3': 'var(--bkg-3)',
